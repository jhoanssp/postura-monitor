...
class OnboardingWizard(QMainWindow):
    ...
    def _estilos(self):
        ...
        self.setStyleSheet(f"""
            ...
            QPushButton#nav:hover{{background:{hov};}}
            QPushButton#nav:checked{{background:{pri};color:white;}}
            QPushButton{{background:{pri};color:white;border:none;
            ...
            QGroupBox{{font-weight:500;font-size:{fs(12)}px;
            ...
            QLineEdit{{border:1px solid {brd};border-radius:{_s(7,f)}px;
                padding:{_s(6,f)}px;background:{card};color:{txt};font-size:{fs(12)}px;}}
            QLineEdit:focus{{border-color:{pri};}}
            QTextEdit{{border:1px solid {brd};border-radius:{_s(7,f)}px;
    ...
    def _pg_inicio(self):
        ...
        for img_n, texto in [("IA.jpg","Detección IA"),("telegram.png","Alertas Telegram"),("supabase.jpg","Datos nube")]:
            col = QVBoxLayout()
            p = _pix(img_n, _s(38,self._f), _s(38,self._f))
    ...
    def _pg_terminos(self):
        ...
        b_back.clicked.connect(lambda: self._ir(0))
    ...
    def _pg_telegram(self):
        ...
        row = QHBoxLayout()
        b_back = QPushButton("Atrás"); b_back.setObjectName("secondary")
        b_back.clicked.connect(lambda: self._ir(1))
    ...
    def _pg_preferencias(self):
        ...
        desc.setStyleSheet(f"color:#6c6c70;font-size:{max(9,int(11*self._f))}px;")
        desc.setWordWrap(True); al.addWidget(desc)
